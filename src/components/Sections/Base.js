...
function Base() {
  ...
  return (
    <section id='la-base' className='flex flex-col container mx-auto'>
      <div className='mt-8 lg:mt-0 relative lg:top-24 flex flex-col-reverse lg:flex-row items-center z-10'>
        ...
        <div className='mx-auto lg:mr-0 lg:ml-auto lg:pb-4 text-center lg:text-right lg:pl-4 lg:w-2/3'>
          <h1 className='main-title text-3xl lg:text-8xl uppercase text-black font-bold tracking-wide'>
            La Base
          </h1>
          <p className='lg:text-3xl uppercase text-black font-bold tracking-wide'>
            Che fa la differenza
          </p>
        </div>
      </div>
      {/* <span className='lg:hidden block border-b-4 border-red-500 mx-auto h-4 w-4/12'></span>

      <h3 className='block mt-4 lg:hidden text-center text-red-500 mb-8'>
        Fresca, fragrante e artigianale.
      </h3> */}
