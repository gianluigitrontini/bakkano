    ...
    return carouselData.map((item) => {
      return (
        <div
          ...
          className={`border-b-2 border-red-500 absolute top-0 bottom-0 left-0 right-0 h-screen w-full w-full transition-opacity animate-zoom-slowly overflow-hidden fixed-image-background ${
